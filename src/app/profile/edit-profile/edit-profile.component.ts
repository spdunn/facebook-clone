...
export class EditProfileComponent implements OnInit {
  ...
  onSubmit() {
    ...
    let updatedUser = new User(this.user.id, this.profileForm.value.firstName, this.profileForm.value.lastName, this.profileForm.value.email, this.profileForm.value.profileImage, this.user.friends)
